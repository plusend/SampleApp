...
//    UIViewController *controller1 = [[UIViewController alloc] init];
    ...
    mineViewController.tabBarItem.title = @"Me";
    mineViewController.tabBarItem.image = [UIImage imageNamed:@"icon.bundle/home"];
    mineViewController.tabBarItem.selectedImage = [UIImage imageNamed:@"icon.bundle/home_selected"];

    [tabbarController setViewControllers:@[viewController, videoController, recommendViewController, mineViewController]];
